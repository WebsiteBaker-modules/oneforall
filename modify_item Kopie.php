	...
	$(function() {
		...
		uploader.bind('FileUploaded', function(up, file, res) {
			...
			if (res_obj.result === null) {
				...
				$('#mod_oneforall_images_b tbody').append('<tr id="id_' + img_id + '"><td style="width: 94px;"><a href="<?php echo WB_URL; ?>/media/<?php echo $mod_name; ?>/images/item<?php echo $item_id; ?>/' + filename + '" target="_blank"><img src="<?php echo WB_URL; ?>/media/<?php echo $mod_name; ?>/thumbs/item<?php echo $item_id; ?>/' + filename + '" alt="" height="40" border="0"></a></td><td style="width: 351px;"><a href="<?php echo WB_URL; ?>/media/<?php echo $mod_name; ?>/images/item<?php echo $item_id; ?>/' + filename + '" target="_blank">' + filename + '</a></td><td style="width: 156px;"><input type="text" name="images[' + img_id + '][title]" style="width: 150px;" maxlength="255" value=""><input type="text" name="images[' + img_id + '][alt]" style="width: 150px;" maxlength="255" value=""></td><td style="width: 206px;"><textarea name="images[' + img_id + '][caption]" rows="3" style="width: 200px;"></textarea></td><td></td><td></td><td style="width: 32px;"><input type="checkbox" name="images[' + img_id + '][active]" value="1" checked="checked"></td><td></td></tr>');
			}
