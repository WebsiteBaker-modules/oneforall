...
$query_page_settings = $database->query('SELECT * FROM `'.TABLE_PREFIX.'mod_'.$mod_name.'_page_settings` WHERE `section_id` = '.(int)$section_id.' ');
...
// Save page settings   ?>
<table class="mod_ofa_modify_item ofa_bottom mod_<?php echo $mod_name; ?>_submit_b">
    <tr>
